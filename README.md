...
- [Anomaly Detection Learning Resources](#anomaly-detection-learning-resources)
    ...
    - [2. Papers](#2-papers)
        - [2.1. Overview & Survey Papers](#21-overview-survey-papers)
        ...
        - [2.5. High-dimensional & Subspace Outliers](#25-high-dimensional-subspace-outliers)
        - [2.6. Outlier Ensembles](#26-outlier-ensembles)
