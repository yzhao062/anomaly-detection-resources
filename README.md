...
- [Anomaly Detection Learning Resources](#anomaly-detection-learning-resources)
    ...
    - [4. Papers](#4-papers)
        ...
        - [4.2. Graph & Network Outlier Detection](#42-graph-network-outlier-detection)
        - [4.3. Time Series Outlier Detection](#43-time-series-outlier-detection)
        - [4.4. Spatial Outliers](#44-spatial-outliers)
        - [4.5. High-dimensional & Subspace Outliers](#45-high-dimensional-subspace-outliers)
        - [4.6. Outlier Ensembles](#46-outlier-ensembles)
...
### 4.2. Graph & Network Outlier Detection
...
### 4.3. Time Series Outlier Detection
...
### 4.4. Spatial Outliers

### 4.5. High-dimensional & Subspace Outliers
...
[ACM InternationalConference on Information and Knowledge Management](http://www.cikmconference.org/)

[ACM International Conference on Web Search and Data Mining](http://www.wsdm-conference.org/2018/)
